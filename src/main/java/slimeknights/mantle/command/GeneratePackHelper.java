...
public class GeneratePackHelper {
  ...
  public static final DynamicCommandExceptionType FAILED_SAVE = new DynamicCommandExceptionType(id -> Mantle.makeComponent("command", "remove.failed_save", id.toString()));
