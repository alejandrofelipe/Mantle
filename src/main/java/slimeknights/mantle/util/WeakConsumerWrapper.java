 ...
 * Designed for use as a capability invalidation listener, to prevent the capability owner from keeping a
 * reference to the listener TE and preventing garbage collection.
